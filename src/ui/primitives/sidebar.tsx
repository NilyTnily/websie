...
const SidebarTrigger = ({
  ...
  ref?: React.RefObject<null | React.ElementRef<typeof Button>>;
}) => {
...
const SidebarInput = ({
  ...
  ref?: React.RefObject<null | React.ElementRef<typeof Input>>;
}) => {
  return (
    <Input
      className={cn(
...
const SidebarSeparator = ({
  ...
  ref?: React.RefObject<null | React.ElementRef<typeof Separator>>;
}) => {
  return (
    <Separator
